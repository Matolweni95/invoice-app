  ...
  return (
    <div className='login'>
      <div className=' relative flex items-center justify-center h-screen'>
        ...
        <div className={`login_underline ${isLogin ? 'bg-vanilla h-[5px]' : 'bg-vanilla h-[2px] mt-[3px]'} w-[114px]`}></div>
      </div>
      <div>
        <button
        ...
        <div className={`register_underline ${isLogin ? 'bg-register h-[2px] mt-[3px]' : 'bg-register h-[5px]'} w-[114px] h-[2px]`}></div>
      </div>
          </div>
          <div>
