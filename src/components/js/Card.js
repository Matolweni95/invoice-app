...
function Card({ data }) {
  ...
  return (
   ...
   <Link className='w-full md:w-auto' to={`../view/${id}`}>
    <div className='card w-full md:w-[300px] flex flex-col md:flex-row gap-5  justify-between p-7 bg-card rounded-lg'>
        <div className='flex justify-between w-full md:w-[350px] text-cream'>
            <div className=''>
